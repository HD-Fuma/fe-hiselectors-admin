...
function RevenueTrend({ dailyTrend }: { dailyTrend: readonly DailyRevenuePoint[] | null }) {
  ...
  const option: EChartsOption = {
    ...
    series: [
      ...
      {
        type: "effectScatter",
        data: [[dayLabel(latest.date), latest.salesAmount]],
        itemStyle: { color: REVENUE_COLORS.sales },
        rippleEffect: { brushType: "stroke", number: 2, period: 3, scale: 2.8 },
        showEffectOn: "render",
        silent: true,
        symbolSize: 8,
        tooltip: { show: false },
      ...
      {
        type: "effectScatter",
        data: [[dayLabel(latest.date), latest.settlementAmount]],
        itemStyle: { color: REVENUE_COLORS.settlement },
        rippleEffect: { brushType: "stroke", number: 2, period: 3.4, scale: 2.6 },
        showEffectOn: "render",
        silent: true,
        symbolSize: 7,
        tooltip: { show: false },
