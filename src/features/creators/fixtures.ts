    ...
    featuredContents: [
      {
        ...
        views: 98_600,
        visual: "fashion",
        thumbnailUrl: "/creator-media/cr-001-01.jpg",
      },
      {
        id: "seo-tone",
        title: "가을 톤 메이크업",
        ...
        views: 74_200,
        visual: "beauty",
        thumbnailUrl: "/creator-media/cr-001-02.jpg",
      },
      {
        id: "seo-video",
        title: "5분 출근 룩북",
        ...
        views: 63_100,
        visual: "skincare",
        thumbnailUrl: "/creator-media/cr-001-03.jpg",
      },
    ],
    ...
    featuredContents: [
      {
        ...
        views: 54_800,
        visual: "cooking",
        thumbnailUrl: "/creator-media/cr-002-01.jpg",
      },
      {
        id: "doyoon-coffee",
        title: "홈카페 레시피",
        ...
        views: 37_400,
        visual: "coffee",
        thumbnailUrl: "/creator-media/cr-002-02.jpg",
      },
      {
        id: "doyoon-table",
        title: "주말 한 상",
        ...
        views: 29_600,
        visual: "table",
        thumbnailUrl: "/creator-media/cr-002-03.jpg",
      },
    ],
    aiReport: {
      status: "ready",
    ...
    featuredContents: [
      {
        ...
        views: 218_000,
        visual: "dessert",
        thumbnailUrl: "/creator-media/cr-004-01.jpg",
      },
      {
        id: "haneul-table",
        title: "오늘의 브런치",
        ...
        views: 184_000,
        visual: "table",
        thumbnailUrl: "/creator-media/cr-004-02.jpg",
      },
      {
        id: "haneul-coffee",
        title: "카페 신메뉴 리뷰",
        ...
        views: 169_000,
        visual: "coffee",
        thumbnailUrl: "/creator-media/cr-004-03.jpg",
      },
    ],
    aiReport: {
      status: "ready",
